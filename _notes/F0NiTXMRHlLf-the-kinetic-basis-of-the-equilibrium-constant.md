...
permalink: /F0NiTXMRHlLf/the-kinetic-basis-of-the-equilibrium-constant
redirect_from:
  - /F0NiTXMRHlLf
...
This transformation might seem arbitrary but it is a fairly obvious consequence of reaction kinetics. Recall that we can write a [rate equations][rate_equation] for the forward reaction like so:
