---
layout: post
title: "What makes a good spaced repetition system? (jpdb.io)"
date: 2026-04-15 22:01 -0700
permalink: /0THf60NuwInF/what-makes-a-good-spaced-repetition-system-jpdbio
redirect_from:
  - /0THf60NuwInF
tags: [japanese, language-learning, recommended, spaced-repetition, inkhaven]
---

*I recommend [reading yesterday's post](/v8mH7WGj5fNz/what-makes-a-good-spaced-repetition-system-wanikani) discussing my follies with WaniKani the first time I tried learning Kanji.*
...
jpdb.io's flashcard system/lessons are simpler than WaniKani's. There are only two kinds: kanji flashcards (which includes radicals) and vocabulary flashcards. Kanji flashcards come with mnemonics[^mnemonics] ask you to visualize or draw the kanji or radical based on its name while vocabulary flashcards ask you to guess the pronunciation/meaning of the word in the context of an example sentence.

[^mnemonics]: At least the most common ~1000 radicals/kanji have mnemonics. I found that learning the most common words in Summer Pockets, I fairly quickly started running into some kanji missing mnemonics. But jpdb.io lets you to define custom mnemonics, which has the added benefit of making it easier to remember your mnemonic (assuming you try reasonably hard to make one).
