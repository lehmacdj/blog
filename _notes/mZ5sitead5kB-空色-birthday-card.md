...
date: 2026-04-08 19:00 -0700
permalink: /mZ5sitead5kB/空色-birthday-card
redirect_from:
  - /mZ5sitead5kB
tags: [personal, idol, idolm@ster, music, review, birthdays, recommended, inkhaven]
---
...
I'll excerpt and translate the relevant lyrics; if you're interested you can find the complete lyrics and a translation [on the Idolm@ster Wiki](https://project-imas.wiki/Sorairo%E2%99%A1_Birthday_Card). If you want to listen, I prefer the short MV version of the song anyways[^why], or here's a link to [the full length version on YouTube Music](https://music.youtube.com/watch?v=kKchFxhtSJY):
...
[^why]: The verses are sung in relay with a rawer, more intimate feel than the full length version where the verses are sung in chorus.
...
> "友達"として
>
> (I wish) for you to keep smiling \
> As a "friend"
...
> 私らしく
>
> (Looking up at the sky) I'll try to smile \
...
> (Far　遥かきみへ) 指先で「ありがとう」
>
> (Softly, melting into the sky) Happy Birthday \
